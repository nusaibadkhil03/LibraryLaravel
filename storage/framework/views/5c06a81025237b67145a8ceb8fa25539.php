...
.journals-full-page {
    ...
    background:
        ...
        url("<?php echo e(asset('images/journals-bg.jpeg')); ?>");
                    ...
                    <div class="journals-full-card">
                        ...
                        <div class="journals-full-body">
                            ...
                            <div class="journals-full-meta">
                                <?php if($journal->issue_number): ?>
                                    <span>العدد <?php echo e($journal->issue_number); ?></span>
                                <?php endif; ?>

                                <?php if($journal->publication_year): ?>
                                    <span><?php echo e($journal->publication_year); ?></span>
                                <?php endif; ?>

                                <?php if($journal->publication_date): ?>
                                    <span><?php echo e($journal->publication_date); ?></span>
                                <?php endif; ?>
                            </div>

                            <?php if($journal->publisher): ?>
                                <div class="journals-full-publisher">
                                    الناشر: <?php echo e($journal->publisher); ?>

                                </div>
                            <?php endif; ?>

                            <p class="journals-full-description">
                                <?php echo e($journal->description ? Str::limit($journal->description, 90) : 'لا يوجد وصف مضاف لهذه المجلة.'); ?>

                            </p>

                            <div class="journals-full-actions">
                                <a href="<?php echo e(asset('storage/' . $journal->file_path)); ?>"
                                   target="_blank"
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\course laravel\LibraryLaravel\resources\views/journals/index.blade.php ENDPATH**/ ?>