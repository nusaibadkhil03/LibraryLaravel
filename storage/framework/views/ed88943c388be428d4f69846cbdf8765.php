...
<div class="admin-form-page">
    ...
    <div class="admin-form-header">
        ...
        <a href="<?php echo e(route('admin.researches.index')); ?>" class="admin-back-btn">
            رجوع
        </a>
    </div>

    <div class="admin-form-card">
        <form action="<?php echo e(route('admin.researches.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\course laravel\LibraryLaravel\resources\views/admin/researches/create.blade.php ENDPATH**/ ?>