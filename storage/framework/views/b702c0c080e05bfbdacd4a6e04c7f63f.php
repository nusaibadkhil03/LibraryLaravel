...
<tr>
    ...
    <td><?php echo e($borrow->student_number ?? '-'); ?></td>

    <td><?php echo e($borrow->libraryBook->title ?? '-'); ?></td>

    <td><?php echo e($borrow->libraryBook->author ?? '-'); ?></td>

    <td><?php echo e($borrow->libraryBook->edition_number ?? '-'); ?></td>
            ...
            <td style="padding:10px; display:flex; gap:8px; justify-content:center;">
                ...
                <?php elseif($borrow->status == 'borrowed' || $borrow->status == 'approved'): ?>
                    ...
                    <form method="POST" action="<?php echo e(route('admin.borrows.return', $borrow->id)); ?>">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
                            style="background:#007bff; color:white; border:none; padding:8px 14px; border-radius:8px; cursor:pointer;">
                            إرجاع
                        </button>
                    </form>
